...
encapsia run task walkthrough_test test_module.test_function_with_no_args || true

test "Run task function with fixed arg and no meta. This *should* fail!!!"
encapsia run task walkthrough_test test_module.test_function_with_single_arg_and_no_meta name=tim || true

test "Run task function with arg and no meta. This *should* fail!!!"
encapsia run task walkthrough_test test_module.test_function_with_single_kwarg name=tim || true

test "Run task function expecting uploaded data but without any data. This *should* fail!!!"
encapsia run task walkthrough_test test_module.test_function_for_posted_data || true
